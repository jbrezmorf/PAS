...
%\begin{itemize}
% \item creating a vector: \verb'vx=c(1,2,3)'
% \item operations are elementwise: \verb'c(1,2)*c(3,4)' gives \verb'[3,8]'
% \item for scalar product (and matrix multiplication) use: \verb'va %*% vb'
% \item can obtain subvectors: \verb'v[1:5]', \verb'v[seq(1,6,2)]', \verb'v[v>3]' 
%\end{itemize}
%\end{frame}
%
