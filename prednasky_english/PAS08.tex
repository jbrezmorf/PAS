...
\blue{Example}  ČSSD gained $30\%$ in the last votes, survey after half a year, $59$ respondents, $25\%$. Can we conclude that 
there is a drop in preferences with probability $80\%$?
...
\begin{enumerate}
 ...
 \pause
 \item Select the significance level \cz{hladina významnosti} $\alpha$.
 \pause
...
\xskip
\df{error of the second kind} - do not reject $H_0$ that doesn't hold,  minimize using larger sample 
   or better test (ASSUMPTIONS !!)
